#!/usr/bin/env python3
"""
Final fix for Semaphore template update
"""
...
def main():
    ...
    update_data = {
        ...
        "app": vlan_template.get('app', 'ansible'),  # Use 'app' field, not 'app_id'
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("\n🧪 You can now test the template with:")
            print("  - switch_name: arista_core")
            print("  - port_interface: Ethernet1/10")
            print("  - vlan_id: 3")
            print("  - port_desc: Test Port Assignment")
            return True
        else:
